...
Дата рождение:<input type="text" name="mail" /><br><br>
Логин:<input type="text" name="mail" /><br><br>
Пароль:<input type="text" name="mail" /><br><br>
Повтор пароля:<input type="text" name="mail" /><br><br>
